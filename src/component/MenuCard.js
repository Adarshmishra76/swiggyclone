...
export default function MenuCard({menuItems, foodselected}){ 
    ...
    // Handle categories if they exist (optional)
        ...
        return(
            <div className="w-full">
                <div className="flex justify-between items-center w-full">
                    ...
                    <button 
                        className="text-5xl font-bold mr-20 cursor-pointer" 
                        onClick={() => setIsOpen(true)}  // Changed to set true
                    >
                        ⌄
                    </button>
                </div>
    ...
    return(
        ...
        <div className="w-full">
            <div className="flex justify-between items-center w-full">
                ...
                <button 
                    className="text-5xl font-bold mr-20 cursor-pointer" 
                    onClick={() => setIsOpen(false)}  // Changed to set false
                >
                    ^
                </button>
            </div>
